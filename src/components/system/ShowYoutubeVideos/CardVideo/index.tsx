        ...
        >
            <div className='bg-white grid grid-cols-1 sm:grid-cols-3 h-[200px] relative'>
                <div className='hidden sm:block sm:relative'>
                    <Image
                        alt={video.snippet.title + ' image'}
                        fill
                        src={video.snippet.thumbnails.high.url}
                        style={{ objectFit: 'cover' }}
                    />
                </div>
                <div className='sm:col-span-2 flex items-center relative bg-cyan-50 overflow-hidden'>
                    <div
                        className='flex flex-col justify-center space-y-2 px-6'
